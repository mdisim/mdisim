...
export function SelectionBracket({ size = 14, className, active }: MarkProps & { active?: boolean }) {
  return (
    <svg
      width={size}
      height={size}
...
export function DeductMark({ size = 13, className, strokeWidth = 1.5 }: MarkProps) {
  return (
...
export function TraceMark({ size = 13, className }: MarkProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 18 10" fill="none" className={className} aria-hidden="true">
...
export function VerifiedMark({ size = 15, className }: MarkProps) {
  return (
