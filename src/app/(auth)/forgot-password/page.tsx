...
import { HardHat, Mail, ArrowLeft, CheckCircle2, Loader2, Send } from 'lucide-react'
        ...
        <div className="bg-[var(--color-surface)] rounded-2xl p-8 border border-[var(--color-border)] shadow-2xl shadow-black/40">
          {sent ? (
            ...
            <>
              ...
              {error && (
                <div className="mb-4 bg-[var(--color-danger-bg)] border border-[var(--color-danger)]/30 rounded-xl px-4 py-3 text-[var(--color-danger)] text-sm">
                  {error}
                </div>
              )}
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="block text-sm text-[var(--color-text-secondary)] mb-1.5" htmlFor="fp-email">
                    Email address
                  </label>
